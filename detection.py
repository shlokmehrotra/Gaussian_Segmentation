...
def simulateOneGaus(datapoints):
    ...
    for i in range(datapoints):
        ...
        for i in range(30):
            for j in range(30):
                z[i][j] *=1# np.random.uniform(0.95, 1.05, 1)
...
# =============================================================================
    ...
    height, xspot, yspot, width_x, width_y, rot = params
# =============================================================================
#     plt.matshow(diffarray)
#     
# 
...
def realData():
    ...
    for i in range(len(newdata)):
        ...
        x, y, x1, y1, height, he1 , dist = TwoGausData(i, newdata[i])
...
def simTotalAmpErr(datapoints):
    ...
    for i in range(len(gausarr)):
        ...
        x, y, x1, y1, height, he1, dista = TwoGausData(i, gausarr[i])
...
def twoSpotLoc(datapoints):
    ...
    for i in range(len(gausarr)):
        ...
        error.append(err)
    plt.figure()
    plt.ylabel("Error in Pixel distance (of both spots)")
    plt.xlabel("Distance between Gaussians")
    #linepar = np.poly1d(np.polyfit(dist, error, 1))
